...
class TestFeatureStoreClient(unittest.TestCase):
    ...
    def test_get_feature_vector(self):
        ...
        self.client.put_feature("feature1", {"name": "Feature 1", "values": {"entity1": 1.0}})
        self.client.put_feature("feature2", {"name": "Feature 2", "values": {"entity1": 2.0}})
...
class TestMLXOptimizer(unittest.TestCase):
    ...
    def test_optimize_aggressive_level(self, mock_quantize, mock_compile):
        ...
        mock_compile.assert_called_once_with("quantized_model", optimize_for_inference=True)
